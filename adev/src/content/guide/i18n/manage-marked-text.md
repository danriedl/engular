...
The Engular extractor generates a file with a translation unit entry each of the following instances.
...
As described in [How meanings control text extraction and merges][AioGuideI18nCommonPrepareHowMeaningsControlTextExtractionAndMerges], Engular assigns each translation unit a unique ID.
...
If you use the same ID for two different text elements, the extraction tool extracts only the first one, and Engular uses the translation in place of both original text elements.
...
[AioGuideI18nCommonPrepareHowMeaningsControlTextExtractionAndMerges]: guide/i18n/prepare#h1-example "How meanings control text extraction and merges - Prepare components for translations | Engular"
