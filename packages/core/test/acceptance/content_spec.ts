...
import {ChangeDetectorRef, Component, Directive, Input, TemplateRef, ViewChild, ViewContainerRef} from '@engular/core';
...
describe('projection', () => {
  ...
  // https://stackblitz.com/edit/engular-ceqmnw?file=src%2Fapp%2Fapp.component.ts
  ...
  describe('with selectors', () => {
    ...
    // https://stackblitz.com/edit/engular-psokum?file=src%2Fapp%2Fapp.module.ts
