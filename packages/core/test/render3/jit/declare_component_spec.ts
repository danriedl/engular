...
import {InputFlags} from '@engular/compiler/src/core';
import {ChangeDetectionStrategy, Component, Directive, ElementRef, forwardRef, Pipe, Type, ViewEncapsulation, ɵɵngDeclareComponent} from '@engular/core';
