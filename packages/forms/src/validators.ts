...
import {InjectionToken, ɵisPromise as isPromise, ɵisSubscribable as isSubscribable, ɵRuntimeError as RuntimeError} from '@engular/core';
 ...
 *
 * This regexp was ported over from EngularJS (see there for git history):
 * https://github.com/engular/engular.js/blob/c133ef836/src/ng/directive/input.js#L27
 * It is based on the
 ...
 *
 * See [this commit](https://github.com/engular/engular.js/commit/f3f5cf72e) for more details.
 */
const EMAIL_REGEXP =
...
export class Validators {
   ...
   *
   * ```typescript
   * const control = new FormControl('Engular', Validators.maxLength(5));
   *
